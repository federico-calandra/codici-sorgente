...
%% INTESTAZIONI
\titleformat{\chapter}[hang]{\normalfont\huge\bfseries}{\thechapter\quad}{0}{}
...
\titlespacing*{\section}{0pt}{.3cm}{0pt}
\titlespacing*{\subsection}{.2cm}{.1cm}{-.1cm}
\titlespacing*{\subsubsection}{.35cm}{0p5}{-.1cm}
...
%% GEOMETRIA
\geometry{top=.1cm,bottom=.1cm,left=.5cm,right=.5cm}
